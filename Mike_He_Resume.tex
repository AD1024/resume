...
%----------------------------------------------------------------------------------------
	...
	\vspace{-5pt}
        \begin{itemize}[leftmargin=*]
            ...
            \item Interests of Studies: Programming Languages \& Formal Verification \& Compilers
		\end{itemize}
		\vspace{-5pt}
...
%----------------------------------------------------------------------------------------
	...
	\begin{rSection}{Skills}
		\begin{tabular}{ @{} >{\bfseries}l @{\hspace{4ex}} l }
			Languages & Python, Java, Rust, Haskell, Agda, OCaml, \LaTeX \\
			Skills    & Certified Programming, Functional Programming, Automated Verification \\
			Others    & I've been playing the violin for 16 years. \\ &I like Symphonies composed by \href{https://imslp.org/wiki/Category:Mahler,_Gustav}{Gustav Mahler}.
		\end{tabular}
	\end{rSection}
...
%----------------------------------------------------------------------------------------
	...
	%------------------------------------------------ 
		...
		\begin{rSubsection}{PLSE}{Oct. 2019---Now}{Research Assistant}{Seattle, WA} 
			\item Working on 3LA Marlowe, aiming to find verified and automated compilation from Deep Learning models (Relay) to accelerators (e.g. FlexNLP). (Summer RA).
	...
	\begin{rSection}{Projects}
		...
		A Demonic Graph Synthesizer (data structure synthesizer) using \href{https://github.com/emina/rosette}{\textsc{Rosette}} that aims for worst-case performance of graph-related algorithms (e.g. SSSP).
		% \vspace{-5pt}
		...
		An auto-active program verification library for Python3 base on verification condition of Hoare Logic.
		...
		An implementation of a proof assistant based on Dependently-typed Lambda Calculus.
